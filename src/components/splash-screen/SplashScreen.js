...
const GradientBox = styled("div")(({ theme }) => {
    ...
    return {
        position: "relative",
        ":before": { ...COMMON_STYLE },
        ":after": { ...COMMON_STYLE, filter: "blur(30px)", opacity: 0.65 },
    };
});
...
const SplashScreen = () => (_jsx(RootStyle, { children: _jsx(GradientBox, { children: _jsx(Box, { p: 4, zIndex: 1, width: 100, height: 100, component: Card, borderRadius: "50%", position: "relative", boxSizing: "border-box", children: _jsx(Box, { component: "img", src: "/static/logo/logo-svg.svg", alt: "essence", width: "100%" }) }) }) }));
