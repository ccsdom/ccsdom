...
const LoaderWithLogo = () => (_jsxs(RootStyle, { className: "loading-wrapper", children: [_jsx("div", { className: "logo", children: _jsx("img", { src: "/static/logo/logo-svg.svg", alt: "essence" }) }), _jsx("div", { className: "loading-content" })] }));
