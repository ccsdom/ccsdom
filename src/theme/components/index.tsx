...
const componentsOverride = (theme: Theme): Components => {
  const { primary, grey, text, background } = theme.palette;

  // —— Palette Mira centralisée ici
  const MIRA = {
    pageBg: background.default, // #f4f5f9
    timeline: "#9083c5",        // Stepper / Timeline
    primary: primary.main,      // #8649e1
  };
  ...
  return {
    ...
    MuiStepIcon: {
      styleOverrides: {
        root: {
          color: alpha(MIRA.timeline, 0.4),
          "&.Mui-active": { color: MIRA.primary },
          "&.Mui-completed": { color: MIRA.primary },
        },
        text: { fill: "#fff" },
      },
    },
    MuiStepConnector: {
      styleOverrides: {
        line: { borderColor: MIRA.timeline },
      },
    },
    ...
    MuiCheckbox: {
      ...
      styleOverrides: {
        root: {
          "&.Mui-checked": { color: MIRA.primary },
          "&.MuiCheckbox-indeterminate": { color: MIRA.primary },
        },
      },
    },
    ...
    MuiTimelineDot: {
      ...
      styleOverrides: {
        filledGrey: {
          backgroundColor: alpha(MIRA.timeline, 0.3),
          "& .MuiSvgIcon-root": { color: MIRA.timeline },
        },
      },
    },
    ...
    MuiTimelineConnector: {
      styleOverrides: {
        root: { backgroundColor: MIRA.timeline },
      },
    },
    ...
    MuiTreeItem: {
      styleOverrides: {
        root: {
          ".MuiTreeItem-content": { borderRadius: 4 },
        },
      },
    },
