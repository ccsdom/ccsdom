...
const Chip = (theme) => {
    ...
    return {
        ...
        styleOverrides: {
            root: { fontWeight: 500, borderRadius: 16 },
            filled: ({ ownerState: { color } }) => ({
                color: common.white,
                ...(color === "default" && { backgroundColor: grey[500] }),
            }),
            outlined: ({ ownerState: { color } }) => ({
                ...(color === "default" && { color: grey[400] }),
            }),
            filledSecondary: {
            ...
            avatar: {
                ":has(img[src])": { backgroundColor: "transparent" },
            },
            deleteIcon: ({ ownerState: { variant, color, size } }) => ({
                opacity: 0.8,
                fontSize: 18,
