...
// --- WARNING (laisse tel quel, petite coquille d’origine conservée)
...
// --- SECONDARY (main modifié -> 9083c5)
export const secondary = {
  ...grey,
  main: "#9083c5", // 👈 Mira secondary (timeline, etc.)
};
...
export const lightPalette = {
  ...
  action: actionLight,
  background: {
    default: "#f4f5f9", // 👈 Mira page background
    paper: "#ffffff",
  },
};
