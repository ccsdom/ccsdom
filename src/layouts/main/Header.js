...
const Header = () => {
    ...
    const LARGE_DEVICE_CONTENT = (_jsxs(FlexBox, { component: "nav", sx: LIST_STYLE, children: [_jsx(Box, { component: Link, href: "/", color: isActive("/") ? "primary.main" : "text.primary", children: "Home" }), _jsx(MegaMenu, {}), _jsx(Box, { component: Link, href: "/components", color: isActive("/") ? "primary.main" : "text.primary", children: "Components" }), _jsx(Box, { component: Link, href: "https://essence-doc.vercel.app", color: "text.primary", children: "Documentation" }), _jsx(Button, { children: "Buy Now" })] }));
    ...
    return (_jsxs(FlexBetween, { component: "header", py: 2, children: [_jsx(Box, { display: "flex", component: Link, href: "/", alignItems: "center", gap: 0.5, children: _jsx("img", { src: "/static/logo/logo-svg.svg", alt: "Essence admin", width: 35, height: 35 }) }), isMedium ? LARGE_DEVICE_CONTENT : SMALL_DEVICE_CONTENT] }));
};
