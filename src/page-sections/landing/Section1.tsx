      ...
      <Container maxWidth="md">
        <Box textAlign="center" mb={5}>
          ...
          <Paragraph color="white" fontSize={18} mt={1}>
            Choose from React CRA/Vite/Next.js versions, <br /> with both RTL
            support and Dark/Light themes included.
          </Paragraph>
            ...
            <ShadowBox value={0.025} textAlign="center">
              <ImageBox>
                <Card
                  ...
                  component="img"
                  loading="eager"
                  src="/static/landing/dashboard.jpg"
                  sx={{
                    zIndex: 1,
                    width: "100%",
                    display: "block",
