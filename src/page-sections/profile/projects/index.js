...
const Projects = () => {
    return (_jsx(Box, { py: 3, children: _jsx(Grid, { container: true, spacing: 3, children: PROJECT_LIST.map((item) => (_jsx(Grid, { item: true, md: 4, sm: 6, xs: 12, children: _jsx(ProjectCard, { Icon: item.icon, title: item.title, value: item.value, status: item.status, description: item.description }) }, item.id))) }) }));
};
