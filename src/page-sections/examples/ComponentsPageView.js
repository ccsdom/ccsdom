...
const ComponentsPageView = () => {
    return (_jsxs(Fragment, { children: [_jsxs(Container, { sx: { py: { sm: 10, xs: 5 } }, children: [_jsx(H1, { fontSize: 32, children: "Components" }), _jsx(Paragraph, { color: "text.secondary", fontSize: 18, mt: 0.6, maxWidth: { sm: 500 }, children: "Making deployment simple and expanding more successfully with a large resource pack" })] }), _jsx(Divider, {}), _jsxs(Container, { sx: { py: { sm: 10, xs: 5 } }, children: [_jsxs(Box, { mb: 5, children: [_jsx(H5, { fontSize: 20, children: "MUI" }), _jsxs(Paragraph, { color: "text.secondary", mt: 1, children: ["Components from", " ", _jsx(Link, { href: "https://mui.com/components", target: "_blank", children: "Material UI" }), "."] })] }), _jsx(Grid, { container: true, spacing: 3, children: componentList.map((component, i) => (_jsx(Grid, { item: true, md: 2, sm: 3, xs: 6, children: _jsx(ComponentPreviewCard, { link: component.link, title: component.title, image: component.image }) }, i))) })] }), _jsx(Divider, {})] }));
};
const componentList = [
    {
        id: 1,
