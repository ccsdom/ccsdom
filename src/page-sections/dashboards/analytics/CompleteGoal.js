...
// ==============================================================
const CompleteGoal = ({ chart = "bar" }) => {
    const theme = useTheme();
    // REACT CHART CATEGORIES LABEL
    const chartCategories = ["Sat", "Sun", "Mon", "Tue", "Wed", "Thu", "Fri"];
    // REACT CHART DATA SERIES
    const chartSeries = [{ name: "Tasks", data: [70, 60, 90, 80, 100, 70, 80] }];
    ...
    return (_jsxs(Card, { children: [_jsx(Box, { p: 3, pb: 0, children: _jsx(Title, { title: 41352, percentage: "+12.5%", percentageType: "primary", subtitle: "Completed Goals" }) }), chart === "bar" ? (_jsx(Chart, { type: "bar", options: barChartOptions, series: chartSeries, height: 120 })) : (_jsx(Box, { sx: { "& > div": { minHeight: "0px !important" } }, children: _jsx(Chart, { type: "area", options: areaChartOptions, series: chartSeries, height: 120 }) }))] }));
};
